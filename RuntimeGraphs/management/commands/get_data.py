...
#         csvfile.close()
#         messages(FILE_NAME + " was downloaded successfully", "Success")
...
#         messages("Low time frame chart was refreshed", "Success")
#     except Exception as e:
#         messages(e.message if hasattr(e, 'message') else str(e), "Error")
...
#             }
#             processed_candlesticks.append(candlestick)
#         messages("High time frame chart was refreshed", "Success")
#     except Exception as e:
#         messages(e.message if hasattr(e, 'message') else str(e), "Error")
#     return processed_candlesticks
